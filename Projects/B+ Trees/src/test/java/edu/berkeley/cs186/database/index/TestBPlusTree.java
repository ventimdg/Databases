...
public class TestBPlusTree {
    ...
    public void testDeleteEverything(){
        ...
        iter = tree.scanGreaterEqual(new IntDataBox(1));
        assertFalse(iter.hasNext());
        ...
        iter = tree.scanGreaterEqual(new IntDataBox(25));
        assertTrue(iter.hasNext());
        iter = tree.scanGreaterEqual(new IntDataBox(55));
        assertFalse(iter.hasNext());
        iter = tree.scanGreaterEqual(new IntDataBox(49));
        assertTrue(iter.hasNext());
        iter.next();
        assertFalse(iter.hasNext());
    }
    ...
    public void removeNonexistantKey() {
        ...
        BPlusTree tree = getBPlusTree(Type.intType(), 2);
        BPlusTree remove = getBPlusTree(Type.intType(), 2);
        float fillFactor = 0.75f;
        assertEquals("()", tree.toSexp());
        ...
        tree.bulkLoad(data.iterator(), fillFactor);
        remove.bulkLoad(data.iterator(), fillFactor);
        remove.remove(new IntDataBox(10));
        assertEquals(tree.toSexp(), remove.toSexp());
        remove.remove(new IntDataBox(3));
        assertNotEquals(tree.toSexp(), remove.toSexp());
    }
