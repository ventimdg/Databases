...
public class TestLockUtil {
    ...
    public void myLongTest() {
        lockManager.startLog();
        LockUtil.ensureSufficientLockHeld(pageContexts[0], LockType.S);
        ...
        LockUtil.ensureSufficientLockHeld(pageContexts[4], LockType.S);
        LockUtil.ensureSufficientLockHeld(pageContexts[5], LockType.S);
        LockUtil.ensureSufficientLockHeld(pageContexts[6], LockType.S);
        LockUtil.ensureSufficientLockHeld(pageContexts[7], LockType.S);
        LockUtil.ensureSufficientLockHeld(pageContexts[7], LockType.S);
        LockUtil.ensureSufficientLockHeld(pageContexts[7], LockType.S);
        LockUtil.ensureSufficientLockHeld(pageContexts[7], LockType.S);
        assertEquals(Arrays.asList(
                "acquire 0 database IS",
                "acquire 0 database/table1 IS",
                "acquire 0 database/table1/0 S",
                "acquire 0 database/table1/1 S",
                "acquire 0 database/table1/2 S",
                "acquire 0 database/table1/3 S",
                "acquire 0 database/table1/4 S",
                "acquire 0 database/table1/5 S",
                "acquire 0 database/table1/6 S",
                "acquire 0 database/table1/7 S"
        ), lockManager.log);
        lockManager.clearLog();
        ...
        assertEquals(Arrays.asList(
                "acquire-and-release 0 database/table1 S [database/table1," +
                        " database/table1/0, database/table1/1, database/table1/2," +
                        " database/table1/3, database/table1/4" +
                        ", database/table1/5, database/table1/6, database/table1/7]",
                "promote 0 database IX",
    ...
    public void makesurenoerror() {
        ...
        LockUtil.ensureSufficientLockHeld(pageContexts[4], LockType.X);
        LockUtil.ensureSufficientLockHeld(pageContexts[5], LockType.X);
        LockUtil.ensureSufficientLockHeld(pageContexts[6], LockType.X);
        LockUtil.ensureSufficientLockHeld(pageContexts[7], LockType.X);
        LockUtil.ensureSufficientLockHeld(pageContexts[7], LockType.X);
        LockUtil.ensureSufficientLockHeld(pageContexts[7], LockType.X);
        LockUtil.ensureSufficientLockHeld(pageContexts[7], LockType.X);
        LockUtil.ensureSufficientLockHeld(tableContext, LockType.S);
