    ...
    private class SortMergeIterator implements Iterator<Record> {
        ...
        */
        ...
        private Record fetchNextRecord() {
            ...
            while(!done){
                if(!marked){
                    int compare = compare(leftRecord, rightRecord);
                    while(compare < 0 && leftIterator.hasNext()){
                        leftRecord = leftIterator.next();
                        compare = compare(leftRecord, rightRecord);
                    }
                    ...
                    while(compare > 0 && rightIterator.hasNext()){
                        rightRecord = rightIterator.next();
                ...
                if (compare(leftRecord, rightRecord) == 0){
                    Record answer = leftRecord.concat(rightRecord);
